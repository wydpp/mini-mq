...
package com.dpp.minimq.broker.latency;
...
public class BrokerFixedThreadPoolExecutor extends ThreadPoolExecutor {
    ...
    public <E> BrokerFixedThreadPoolExecutor(int sendMessageThreadPoolNums, int sendMessageThreadPoolNums1, int i, TimeUnit timeUnit, LinkedBlockingDeque<E> es, Object o) {
        super();
    }
