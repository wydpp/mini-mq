...
import com.dpp.minimq.common.utils.ConcurrentHashMapUtils;
...
public class QueueOffsetAssigner {
    private static final Logger log = LoggerFactory.getLogger(QueueOffsetAssigner.class);
